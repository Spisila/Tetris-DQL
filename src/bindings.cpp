...
PYBIND11_MODULE(Tetris_AGENT, m)
{
    ...
    // .def("checkPiecePlaced", &MultiGame::checkPiecePlaced, "Checks which environments set pieces")
    // .def("checkGameLost", &MultiGame::checkGameLost, "Checks what environment has lost");
